    ...
    },
    {
      ...
      quiz: {
        title: "問題", problems: [
          ...
          { question: "ニューロン数2、バイアスありで 原点を通る折れ線 は理論的には学習可能です。しかし実際に実行してみると、十分な学習回数があるにもかかわらずまれに失敗することがあります。その利用として妥当なものを選んでください。", choices: ["重みの初期値によって2つの個別グラフが同じ動きをすることがあるから", "学習率が非常に小さいため、計算結果が途中で四捨五入されてしまうから", "入力データの順番が、常に小さい順に並んでいないから"], correctIndex: 0 },
        ]
      },
    },
  ]
